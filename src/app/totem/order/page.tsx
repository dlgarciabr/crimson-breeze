...
export default function Cart() {
  ...
  return (
    <>
      <header style={{ position: "fixed", top: 0, width: '100%', paddingTop: '10px'}}>
      ...
      <Grid container spacing={2} style={{ paddingBottom: '1000px', marginTop: '60px', paddingTop: '30px', paddingRight: '30px', paddingLeft: '30px'}}>
